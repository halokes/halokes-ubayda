            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('ubayda.business.user.store') }}">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea name="address" class="form-control form-control-lg" id="address" placeholder="Business Address" required>{{ old('address') }}</textarea>
                                </div>
                            </div>
